...
public class URL {
	...
	private final String redirectUrl = "http://localhost:8080/callback";/*
																		 * "http://spotifydata-env.eba-yfeju4iw.us-east-2.elasticbeanstalk.com./callback";
																		 */
	...
	public String getAuthorizationURL() {
		return "https://accounts.spotify.com/en/authorize?client_id=" + clientId + "&response_type=code&redirect_uri="
				+ redirectUrl + "&code_challenge_method=S256&code_challenge=" + getCodeChallenge()
